...
type Word = { id: string; targetText: string; translation: string; type: string; masteryLevel: number; itemKind: 'word' | 'conjugation'; options: string[]; helperForms: Form[]; isIrregular: boolean; contextSentence: string };
...
export default function Review() {
  ...
  async function submit(value: string) {
    ...
    setFeedback({ correct, answer: word.translation, context: word.contextSentence });
