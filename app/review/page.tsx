...
export default function Review() {
  ...
  async function submit(value: string) {
    ...
    const correct = word.masteryLevel < 1 ? value === word.translation : value.trim().toLocaleLowerCase() === word.targetText.trim().toLocaleLowerCase();
