...
export default function ProfilePage() {
  ...
  return <main className="shell grid-paper min-h-screen"><div className="mx-auto max-w-2xl px-5 py-6 md:px-10 md:py-9">
    <header className="flex items-center justify-between border-b border-[#173c3b22] pb-6"><Link href="/learn" aria-label="LanguageRecap dashboard"><Brand className="h-8 w-auto" /></Link><Link href="/learn" className="rounded-md border border-[#173c3b] px-4 py-2 text-sm font-bold text-[#173c3b]">← Dashboard</Link></header>
