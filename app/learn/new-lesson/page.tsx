...
export default function NewLessonPage() {
  ...
  return <main className="shell grid-paper min-h-screen"><div className="mx-auto max-w-6xl px-5 py-6 md:px-10 md:py-9">
    <header className="flex flex-wrap items-center justify-between gap-4 border-b border-[#173c3b22] pb-6"><div><Link href="/learn" aria-label="LanguageRecap dashboard"><Brand className="h-8 w-auto" /></Link><p className="mt-1 text-xs uppercase tracking-[.2em] text-[#6f7e76]">New lesson</p></div><Link href="/learn" className="rounded-md border border-[#173c3b] px-4 py-2 text-sm font-bold text-[#173c3b]">← Dashboard</Link></header>
